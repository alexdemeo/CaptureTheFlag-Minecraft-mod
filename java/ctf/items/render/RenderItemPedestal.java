...
public class RenderItemPedestal implements IItemRenderer {
	...
	protected ModelPedestal model;

	public RenderItemPedestal() {
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		case EQUIPPED:
			...
			Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("ctf:render/pedestal_inv.png"));
